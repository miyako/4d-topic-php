...
#define CONFIGURE_ARGS " '--disable-debug' '--prefix=@@HOMEBREW_CELLAR@@/libpq/15.4' '--with-gssapi' '--with-openssl' '--libdir=@@HOMEBREW_PREFIX@@/opt/libpq/lib' '--includedir=@@HOMEBREW_PREFIX@@/opt/libpq/include' 'CC=clang' 'CXX=clang++' 'PKG_CONFIG_PATH=@@HOMEBREW_PREFIX@@/opt/openssl@3/lib/pkgconfig:@@HOMEBREW_PREFIX@@/opt/krb5/lib/pkgconfig' 'PKG_CONFIG_LIBDIR=/usr/lib/pkgconfig:@@HOMEBREW_LIBRARY@@/Homebrew/os/mac/pkgconfig/11'"
...
#define PG_VERSION_STR "PostgreSQL 15.4 on aarch64-apple-darwin20.6.0, compiled by Apple clang version 13.0.0 (clang-1300.0.29.30), 64-bit"
